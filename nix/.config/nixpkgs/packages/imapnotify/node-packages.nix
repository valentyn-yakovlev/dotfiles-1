...
in
{
  "imapnotify" = nodeEnv.buildNodePackage {
    ...
    version = "0.4.1";
    src = fetchgit {
      url = "https://github.com/a-sk/node-imapnotify";
      rev = "a37456cc5c011892cbc6114653d727c453319784";
      sha256 = "7443a50716a44fcd7bcf7f01d02a1e4a361d92dc8fae04330aa6cb5c9ee3c357";
    };
    dependencies = [
      sources."imap-0.8.19"
