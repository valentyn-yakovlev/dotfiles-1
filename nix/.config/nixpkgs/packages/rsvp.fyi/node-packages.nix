...
in
{
  "rsvp.fyi-client" = nodeEnv.buildNodePackage {
    name = "rsvp.fyi-client";
    packageName = "rsvp.fyi-client";
    version = "1.0.0";
    src = ../../../../rsvp.fyi/client;
    dependencies = [
      ...
      sources."babel-preset-latest-6.24.1"
      ...
      sources."foundation-sites-6.3.1"
      (sources."grunt-1.0.1" // {
        dependencies = [
          sources."js-yaml-3.5.5"
        ];
      })
      (sources."grunt-contrib-clean-1.1.0" // {
        dependencies = [
      ...
      sources."grunt-postcss-0.8.0"
      sources."grunt-sass-2.0.0"
      sources."grunt-scss-lint-0.5.0"
      sources."grunt-webpack-2.0.0-beta.6"
      (sources."load-grunt-config-0.19.2" // {
        dependencies = [
          sources."glob-5.0.15"
          sources."js-yaml-3.4.6"
          sources."lodash-3.10.1"
        ];
      })
      ...
      sources."react-modal-1.7.7"
      sources."react-redux-5.0.4"
      sources."react-router-3.0.5"
      sources."react-router-redux-4.0.8"
      sources."react-swipeable-views-0.10.8"
      sources."react-tap-event-plugin-2.0.1"
      sources."redux-3.6.0"
      sources."redux-batched-actions-0.1.5"
      sources."redux-form-6.6.3"
      sources."redux-logger-2.10.2"
      sources."redux-thunk-2.2.0"
      sources."stats-webpack-plugin-0.4.3"
      (sources."webpack-2.2.0-rc.3" // {
        dependencies = [
      ...
      sources."cson-3.0.2"
      sources."jit-grunt-0.10.0"
      sources."load-grunt-tasks-3.3.0"
      ...
      sources."react-swipeable-views-core-0.10.1"
      sources."react-swipeable-views-utils-0.10.1"
      sources."keycode-2.1.9"
      sources."react-addons-shallow-compare-15.5.2"
      sources."react-event-listener-0.4.5"
  ...
  "rsvp.fyi-server" = nodeEnv.buildNodePackage {
    name = "rsvp.fyi-server";
    packageName = "rsvp.fyi-server";
    version = "1.0.0";
    src = ../../../../rsvp.fyi/server;
    dependencies = [
